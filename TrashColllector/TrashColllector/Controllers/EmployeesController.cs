...
namespace TrashColllector.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,postalCode")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,postalCode")] Employee employee)
        {
            if (ModelState.IsValid)
            {
